%Load Data
load Mymatrix_16node_1220.txt

% load Training Data
X = abs(Mymatrix_16node_1220(:,1)); 
X_pressure= X(:,1);
...
filename = 'finalLabels_1220.xlsx';
...
for k=1:4
    ...
    for p=1:5
        ...
        Ysvm_new(D)=1;
        Xsvm_new = Mymatrix_16node_1220(:,1);
